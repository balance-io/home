            ...
            <div className="">
                <div className="flex md:hidden flex-col items-center m-8">
                    ...
                    <div className="w-full bg-white rounded overflow-x-hidden flex snap-x" >
                        ...
                        <div className="snap-start w-full h-full flex items-center justify-center  flex-shrink-0 " id="slide-3">
                            <div>
                        ...
                        <div className="snap-start w-full h-full flex items-center justify-center  flex-shrink-0 " id="slide-4">
                            <div>
                        ...
                        <div className="snap-start w-full h-full flex items-center justify-center  flex-shrink-0 " id="slide-5">
                        ...
                        <div className="snap-start w-full h-full flex items-center justify-center  flex-shrink-0 " id="slide-6">
                    ...
                    <div className="flex mt-8 space-x-3 ">
                        ...
                        <a className="w-8 h-8 text-gray-700 rounded-full bg-white flex justify-center items-center" href="#slide-5"> <Image src="/assets/icons/evm.jpg" alt="balance" width="20" height="25" className="" /></a>
                        <a className="w-8 h-8 text-gray-700 rounded-full bg-white flex justify-center items-center" href="#slide-6"><Image src="/assets/icons/lock.jpg" alt="balance" width="20" height="25" className="" /></a>
                    </div>
                </div>
            </div>
